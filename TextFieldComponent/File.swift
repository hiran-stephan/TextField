...
struct LoginScreen: View {
    ...
    private var contentView: some View {
        ...
        .modifier(KeyboardAwareModifier()) // Attach keyboard-aware modifier here
...
struct KeyboardAwareModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            .offset(y: -keyboardHeightPublisher.keyboardHeight) // Move content up by keyboard height
            .animation(.easeOut(duration: 0.3), value: keyboardHeightPublisher.keyboardHeight) // Smooth adjustment animation tied to keyboard height
    }
}
